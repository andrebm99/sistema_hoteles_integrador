...
public class UsuarioAController {
    ...
    UsuarioAController(PasswordEncoder passwordEncoder) {
    ...
    public ResponseEntity<Usuario_Administracion> create(@RequestBody Usuario_Administracion entidad) {
        try {
            ...
            newAdmin.setPasswordHash(passwordEncoder.encode(entidad.getPasswordHash()));
    ...
    public ResponseEntity<Usuario_Administracion> update(@PathVariable("id") long id,
            @RequestBody Usuario_Administracion entidad) {
        ...
        if (subjectData.isPresent()) {
            ...
            if (entidad.getPasswordHash() != null && !entidad.getPasswordHash().isBlank()) {
                _subject.setPasswordHash(passwordEncoder.encode(entidad.getPasswordHash()));
            }
